...
STDMETHODIMP CAesLogic::AesEcbEnc(BYTE* szIn,ULONG nInLen,BYTE *szKey,ULONG* pnOutLen,BYTE** pVal)
{
	// TODO: 在此添加实现代码
...
STDMETHODIMP CAesLogic::AesEcbDes(BYTE* szIn,ULONG nInLen,BYTE *szKey,ULONG* pnOutLen,BYTE** pVal)
{
	// TODO: 在此添加实现代码
	if(nInLen < 1 || NULL == szIn || NULL == szKey || NULL == pnOutLen || NULL == pVal)
		return E_POINTER;
...
STDMETHODIMP CAesLogic::AesCbcEnc(BYTE* szIn,ULONG nInLen,BYTE *szKey,BYTE *szIV,ULONG* pnOutLen,BYTE** pVal)
{
	// TODO: 在此添加实现代码
	if(nInLen < 1 || NULL == szIn || NULL == szKey || NULL == pnOutLen || NULL == pVal)
		return E_POINTER;
...
STDMETHODIMP CAesLogic::AesCbcDes(BYTE* szIn,ULONG nInLen,BYTE *szKey,BYTE *szIV,ULONG* pnOutLen,BYTE** pVal)
{
	// TODO: 在此添加实现代码
	if(nInLen < 1 || NULL == szIn || NULL == szKey || NULL == pnOutLen || NULL == pVal)
		return E_POINTER;
...
STDMETHODIMP CAesLogic::AesCfbEnc()
{
	return S_OK;
}

STDMETHODIMP CAesLogic::AesCfbDes()
{
	return S_OK;
}

STDMETHODIMP CAesLogic::AesOfbEnc()
{
	return S_OK;
}

STDMETHODIMP CAesLogic::AesOfbDes()
{
	return S_OK;
}

STDMETHODIMP CAesLogic::Test(void)
{
	// TODO: 在此添加实现代码
...
STDMETHODIMP CAesLogic::ReleaseBuf(BYTE* pBuf)
{
	if(NULL == pBuf)
		return E_POINTER;
	delete []pBuf;
