...
#define SKF_FUN_INFO(name,args) \
	...
	SKF_FUN_INFO(SKF_GenerateKey, (HCONTAINER hContainer, u32 ulAlgId, HANDLE *phSessionKey));
	SKF_FUN_INFO(SKF_ECCExportSessionKeyByHandle, (HANDLE hSessionKey, 
		ECCPUBLICKEYBLOB *pPubKey,PECCCIPHERBLOB pbData));
	SKF_FUN_INFO(SKF_RSAExportSessionKeyByHandle, (HANDLE hSessionKey, 
		RSAPUBLICKEYBLOB *pPubKey, u8 *pbData, u32 *pulDataLen));
	SKF_FUN_INFO(SKF_PrvKeyDecrypt, (HCONTAINER hContainer, u32 ulKeySpec,
		PECCCIPHERBLOB pCipherText, u8 *pbData, u32 *pulDataLen));
	SKF_FUN_INFO(SKF_RSAPrvKeyDecrypt, (HCONTAINER hContainer, u32 ulKeySpec, u8 *pbCipherData, 
...
#define SKF_DEF_FUN_T(name) __PASTE(P_,name)	name
		...
		SKF_DEF_FUN_T(SKF_GenerateKey);
		SKF_DEF_FUN_T(SKF_ECCExportSessionKeyByHandle);
		SKF_DEF_FUN_T(SKF_RSAExportSessionKeyByHandle);
		SKF_DEF_FUN_T(SKF_PrvKeyDecrypt);
		SKF_DEF_FUN_T(SKF_RSAPrvKeyDecrypt);
#undef SKF_DEF_FUN_T
