========================================================================
    活动模板库 : SKFEncryLib 项目概述
========================================================================

应用程序向导已为您创建了此 SKFEncryLib 项目，作为编写动态链接库 (DLL) 
的起点。
...
SKFEncryLib.idl
    ...
    此文件将由 MIDL 编译器处理以生成：
        C++ 接口定义和 GUID 声明		(SKFEncryLib.h)
        GUID 定义			(SKFEncryLib_i.c)
        类型库				(SKFEncryLib.tlb)
        封送处理代码			(SKFEncryLib_p.c 和 
                                           dlldata.c）

SKFEncryLib.h
    此文件包含 SKFEncryLib.idl 中定义的项目的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 SKFEncryLib.pch 的预编译头 (PCH) 文件和
