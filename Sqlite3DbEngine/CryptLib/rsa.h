...
/** \file
	This file contains classes that implement the CRYPTOPP_RSA
...
//! CRYPTOPP_RSA
struct CRYPTOPP_DLL CRYPTOPP_RSA
{
	static const char * CRYPTOPP_API StaticAlgorithmName() {return "CRYPTOPP_RSA";}
	typedef RSAFunction PublicKey;
	typedef InvertibleRSAFunction PrivateKey;
};

//! <a href="http://www.weidai.com/scan-mirror/ca.html#CRYPTOPP_RSA">CRYPTOPP_RSA cryptosystem</a>
template <class STANDARD>
struct RSAES : public TF_ES<STANDARD, CRYPTOPP_RSA>
{
};

//! <a href="http://www.weidai.com/scan-mirror/sig.html#CRYPTOPP_RSA">CRYPTOPP_RSA signature scheme with appendix</a>
/*! See documentation of PKCS1v15 for a list of hash functions that can be used with it. */
template <class STANDARD, class H>
struct RSASS : public TF_SS<STANDARD, H, CRYPTOPP_RSA>
{
};

struct CRYPTOPP_DLL RSA_ISO
{
	static const char * CRYPTOPP_API StaticAlgorithmName() {return "CRYPTOPP_RSA-ISO";}
...
// The two CRYPTOPP_RSA encryption schemes defined in PKCS #1 v2.0
...
// The three CRYPTOPP_RSA signature schemes defined in PKCS #1 v2.0
