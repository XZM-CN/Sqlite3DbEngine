...
void RegisterFactories()
{
	...
	RegisterAsymmetricCipherDefaultFactories<RSAES<OAEP<SHA1> > >("CRYPTOPP_RSA/OAEP-MGF1(SHA-1)");
	...
	RegisterSignatureSchemeDefaultFactories<RSASS<PKCS1v15, Weak::MD2> >("CRYPTOPP_RSA/PKCS1-1.5(MD2)");
	RegisterSignatureSchemeDefaultFactories<RSASS<PKCS1v15, SHA1> >("CRYPTOPP_RSA/PKCS1-1.5(SHA-1)");
	...
	RegisterSignatureSchemeDefaultFactories<RSASS<PSS, SHA1> >("CRYPTOPP_RSA/PSS-MGF1(SHA-1)");
