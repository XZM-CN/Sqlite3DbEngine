// ####################################################################################################
// *****************************************************************************
//                  Copyright (c) 2015, BeiJing RBLYBG Technology Co.,Ltd.
//      THIS IS AN UNPUBLISHED WORK CONTAINING CONFIDENTIAL AND PROPRIETARY
//               INFORMATION WHICH IS THE PROPERTY OF BeiJing RBLYBG TECHNOLOGY CO.,LTD.
//
//    ANY DISCLOSURE, USE, OR REPRODUCTION, WITHOUT WRITTEN AUTHORIZATION FROM
//               BeiJing RBLYBG TECHNOLOGY CO.,LTD. IS STRICTLY PROHIBITED.
// *****************************************************************************
// ####################################################################################################
//
// File:	TreeListWnd.h
...
// Created: 2014/10/24 
//
// Description:  a Tree-List-Wnd for MFC classes definition file.
// ---------------------------------------------------------------------------------------------------
...
typedef struct xzmTV_KEYDOWN_EX
{
	NMHDR			hdr;
	WORD			wVKey;
	WORD			wScan;
...
typedef struct xzmTV_STARTEDIT
{ 
	NMHDR			hdr;
	TVITEM			item;
	UINT			uAction;
...
#endif
#ifndef		VK_EDITCLK
#define 	VK_EDITCLK				0x10002				// Edit mit Klick auf augew鋒ltes Element
#endif
#ifdef		UNICODE
...
// Tree View Color (TVM_SETBKCOLOR)
...
#define 	TVC_FRAME				3					// Farbe f黵 Trennlinien (siehe TVS_EX_ITEMLINES)
#define 	TVC_TEXT				4					// Textfarbe
#define 	TVC_LINE				5					// Innere Farbe der Schaltfl鋍hen
#define 	TVC_BOX					6					// 膗遝re Farbe der Schaltfl鋍hen
#define 	TVC_TRACK				7					// Farbe f黵 getrakte Texte
...
#define 	TVC_INSERT				10					// Farbe der Einf黦emarke
#define 	TVC_BOXBG				11					// Hindergrundfarbe der Schaltfl鋍hen
...
// Tree View Get Next Item (TVM_GETNEXTITEM)
#define 	TVGN_DROPHILITESUB		0x000C				// Ausgew鋒lte Spalte holen
#define 	TVGN_CARETSUB			0x000D				// Drophighilite Spalte holen
#ifndef		TVGN_NEXTSELECTED
#define 	TVGN_NEXTSELECTED		0x000E				// N鋍hster ausgew鋒lter Eintrag
#endif
#define 	TVGN_FOCUS				0x000F				// Eintrag der den Focus hat
#define 	TVGN_FOCUSSUB			0x0010				// Spalte  die den Focus hat
#define 	TVGN_NEXTSELCHILD		0x0011				// N鋍hster ausgew鋒lter Kindeintrag
#define 	TVGN_LASTCHILD			0x0012				// Letzter Kindeintrag
#define 	TVGN_NEXTITEM			0x0013				// F黵 Enumerierung der Eintr鋑e


// Tree View Column Flag (mask)
...
#define 	TVCF_FIXED				0x40000000			// Darf die Spaltenbreite ver鋘dert werden
#define 	TVCF_LASTSIZE			0x44332211			// Breite vor dem Fixieren wieder herstellen


// Tree View Column Format(列格式化，通俗讲就是列的对齐方式) (format mask)
...
#define 	TVCFMT_FIXED			0x20000000			// 固定
#define 	TVCFMT_MARK				0x10000000			// 掩膜


// Tree View Column Auto Edit
...
#define 	TVAE_NEXTLINE			0x0001				// Nach Enter in die n鋍hste Zeile
#define 	TVAE_DBLCLICK			0x0002				// Editieren mit Doppelklick
#define 	TVAE_FULLWIDTH			0x0004				// Combobox 黚er die volle Breite einblenden
#define 	TVAE_PTRLIST			0x0008				// Die Datenliste wird als Zeigerliste 黚ergeben
...
#define 	TVAE_COL(c)				(((c)&0x3F)<<11)	// Ist die Spalte f黵s automatische Editieren
#define 	TVAE_CHAR(c)			(((c)&0xFF)<<17)	// Ist das Trennzeichen f黵 die Datenliste
#define 	TVAE_COUNT(c)			(((c)&0x7F)<<25)	// Bestimmt die Anzahl der Eintr鋑e in der Datenliste (0=auto)
#define 	TVAE_MODEMASK			(7<<TVAE_MODEPOS)	// Maske f黵 die Modusbits
#define 	TVAE_MODEPOS			0x0008				// Maske f黵 die Modusbits
#define 	TVIS_DISABLEBIT			0x8000				// Ist das State-Bit f黵's sperren der Auto-Edit-Option


// Tree View HitTest (flags)
...
#define 	TVHT_ONRIGHTSPACE		0x00800000			// Auf rechtem Rand nach den Extr鋑en
...
// Tree View  GetItemRect (TVM_GETITEMRECT)
...
// Tree View  SelectChilds (TVM_SELECTCHILDS)
#define 	TVIS_WITHCHILDS			0x00000001			// Auch Kinder ausw鋒len
#define 	TVIS_DESELECT			0x00000002			// Eintr鋑e abw鋒len

// Tree View  Optionen (TVM_GETSETOPTION)
#define 	TVOP_AUTOEXPANDOFF		0x00000001			// Icon Offset f黵 TVS_EX_AUTOEXPANDICON
#define 	TVOP_WRITEOPTION		0x80000000			// Die Option auch schreiben


// Tree View EditLabel (LVM_EDITLABEL)
#define 	TVIR_EDITCOMBOCHAR(n)	(((n)&0xFF)<<8)		// Trennzeichen der Combobox-Eintr鋑e (nur f黵 Notify-Nachricht)
#define 	TVIR_EDITCOMBODEL		0x00000080			// L鰏cht den Puffer f黵 die Eintr鋑e (nur f黵 Notify-Nachricht)
#define 	TVIR_EDITCOMBODOWN		0x10000000			// Die Combobox aufklappen (nur f黵 Notify-Nachricht)
...
#define 	TVIR_EDITFULL			0x80000000			// Das Edit-Fenster 黚er die volle Breite einblenden
#define 	TVIR_EDITTEXT			0x00000001			// Das Edit-Fenster 黚er den Text einblenden (nur f黵 Notify-Nachricht)
#define 	TVIR_EDITCOL(u)			((u)&0xFF)			// Splate angeben
#define 	TVIR_SELALL				0x00000000			// Alles w鋒len
#define 	TVIR_SELAREA(a,b)		((0x0C0000|(a&0x1FF)|((b&0x1FF)<<9))<<8)	// Textbereich w鋒len
...
#define 	TVS_EX_HEADERCHGNOTIFY	0x00000800			// Nachrichten versenden wenn eine Spaltenbreite ver鋘dert wurde
#define 	TVS_EX_HEADERDRAGDROP	0x00001000			// Die Spalten ab 1 k鰊nen mit Drag&Drop sortiert werden
...
#define 	TVS_EX_BITCHECKBOX		0x00008000			// Bei Checkboxen nur das unterste Bit 鋘dern
#define 	TVS_EX_ITEMLINES		0x00010000			// Um die Eintr鋑e Linien zeichnen
#define 	TVS_EX_ALTERNATECOLOR	0x00020000			// Die Farbe abwechselnd darstellen
#define 	TVS_EX_SUBSELECT		0x00040000			// Sub-Eintr鋑e seperat ausw鋒len
...
#define 	TVS_EX_AUTOEXPANDICON	0x00200000			// Automatisch das n鋍hste Icon benutzen bei Expandet
#define 	TVS_EX_NOCHARSELCET		0x00400000			// Keine Auswahl 黚er eine Texteingabe
#define 	TVS_EX_NOCOLUMNRESIZE	0x00800000			// Der User darf die Spaltenbreite nicht 鋘dern
...
#define 	TVS_EX_FULLROWITEMS		0x04000000			// Eintr鋑e 黚er die ganze Zeile zeichnen
#define 	TVS_EX_FIXEDCOLSIZE		0x08000000			// Gesamtbreite aller Splaten gleich belassen
#define 	TVS_EX_HOMEENDSELECT	0x10000000			// Mit Ctrl+Home/End das erste und letze Element w鋒len
#define 	TVS_EX_SHAREIMAGELISTS	0x20000000			// Image-Listen nicht l鰏chen bei Fensterzerst鰎ung
#define 	TVS_EX_EDITCLICK		0x40000000			// Mit einem Klick das gew鋒lte Item berabreiten
#define 	TVS_EX_NOCURSORSET		0x80000000			// Bei VK_EDITCLK immer den gesammten Text w鋒len
...
// Notify Message
#define		TVN_ITEMTOOLTIP			(TVN_FIRST-32)		// 通知消息 工具提示窗口
#define     TVN_CBSTATECHANGED      (TVN_FIRST-33)		// 通知消息 复选框
#define		TVN_STEPSTATECHANGED	(TVN_FIRST-34)		// 通知消息 自动编辑时
#define		TVN_STARTEDIT			(TVN_FIRST-35)		// 通知消息 编辑字段
#define 	TVN_LBUTTONUP			(TVN_FIRST-36)		// 通知消息 当鼠标左键被释放
#define 	TVN_RBUTTONUP			(TVN_FIRST-37)		// 通知消息 当鼠标右键被释放
#define 	TVN_COLUMNCHANGED		(TVN_FIRST-38)		// 通知消息 当一列被改变
