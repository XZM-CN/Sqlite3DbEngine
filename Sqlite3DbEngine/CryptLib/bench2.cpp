...
void BenchmarkAll2(double t, double hertz)
{
	...
	BenchMarkCrypto<RSAES<OAEP<SHA> > >("TestData/rsa1024.dat", "CRYPTOPP_RSA 1024", t);
	...
	BenchMarkCrypto<RSAES<OAEP<SHA> > >("TestData/rsa2048.dat", "CRYPTOPP_RSA 2048", t);
	...
	cout << "\n<TBODY style=\"background: yellow\">";
	BenchMarkSignature<RSASS<PSSR, SHA> >("TestData/rsa1024.dat", "CRYPTOPP_RSA 1024", t);
	...
	cout << "\n<TBODY style=\"background: white\">";
	BenchMarkSignature<RSASS<PSSR, SHA> >("TestData/rsa2048.dat", "CRYPTOPP_RSA 2048", t);
